...
addEventListener('keydown', e => {
  ...
  if (e.code === 'Escape' && (input.dragLook || input.touch)) pauseGame();   // otherwise leaving pointer lock pauses
